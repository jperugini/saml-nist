...
class CommonVal {
	...
	private static final Logger log = Logger.getLogger(CommonVal.class)
	...
	public static boolean validEmail(String email){
        log.debug("validating email $email against org.apache.commons.validator.routines.EmailValidator")
