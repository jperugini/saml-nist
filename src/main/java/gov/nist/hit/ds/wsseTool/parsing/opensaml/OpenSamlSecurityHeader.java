...
public class OpenSamlSecurityHeader {
	...
	public Signature getSignature() {
		...
		if(s == null){
			log.error("open saml parser could not find a timestamp signature in the wsseHeader");
		}
	...
	public Assertion getAssertion() {
		...
		if(assertion == null){
			log.error("open saml parser could not find an assertion in the wsseHeader");
		}
