...
One major limitation:  we gather character validation.data for elements in a single
buffer, so mixed-content documents will lose a lot of validation.data!  This works
best with validation.data-centric documents where elements either have single values
    ...
    extends DefaultHandler
{
    ...
    */
    ...
    character validation.data for the element.
    */
    ...
    */
    ...
    validation.data into it, to be gathered when the element end tag is encountered.
    */
    ...
    */
    ...
    /**
    A buffer for character validation.data.  It is &quot;enabled&quot; in 
