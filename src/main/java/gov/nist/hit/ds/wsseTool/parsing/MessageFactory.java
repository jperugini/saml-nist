...
import gov.nist.hit.ds.wsseTool.namespace.dom.UniversalNamespaceCache;
...
public class MessageFactory {
	...
	/*
	 * Build all the representations we need to perform the validation
	 */
	private static Message buildMessage(Element wsseHeader, GenContext context)
		...
		try {
			...
			message.setNamespaces(new UniversalNamespaceCache(wsseHeader, false));
			message.setDefaultNamespaces( NhwinNamespaceContextFactory.getDefaultContext());
			parse(message);
		} catch (Exception e) {
	...
	private static void parse(Message message) throws ParseException {
		new GroovyHeaderParser(message.groovyHeader).parse();
	}
